...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Add New Service Page </h4>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    <textarea id="elm1" name="services_description"></textarea>
            ...
            <!-- end row -->
        <input type="submit" class="btn btn-danger waves-effect waves-light" value="Insert Services Data">
            </form>
